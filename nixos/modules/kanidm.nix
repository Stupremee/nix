...
in {
  ...
  config = lib.mkIf (cfg.enableClient || cfg.enableServer || cfg.enablePam) {
    assertions = [
      {
        ...
        message = ''
          <option>modules.kanidm.serverSettings.tls_chain</option> points to
      ...
      }
      {
        ...
        message = ''
          <option>modules.kanidm.serverSettings.tls_key</option> points to
          a file in the Nix store. You should use a quoted absolute path to
          prevent this.
        '';
      }
      {
        assertion = !cfg.enableClient || options.modules.kanidm.clientSettings.isDefined;
        message = ''
          <option>modules.kanidm.clientSettings</option> needs to be configured
          if the client is enabled.
        '';
      }
      {
        assertion = !cfg.enablePam || options.modules.kanidm.clientSettings.isDefined;
        message = ''
          <option>modules.kanidm.clientSettings</option> needs to be configured
      ...
      }
      {
        ...
        message = ''
          <option>modules.kanidm.serverSettings.domain</option> can only be set if this instance
    ...
    environment.etc = lib.mkMerge [
      (lib.mkIf options.modules.kanidm.clientSettings.isDefined {
